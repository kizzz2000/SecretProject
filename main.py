...
pygame.display.set_caption("My first game") #window name
...
BULLET_FIRE_SOUND = pygame.mixer.Sound("GunShotSnglShotIn PE1097906.mp3")
...
def main():
    ...
    red = pygame.Rect(700, 200, SPACESHIP_HEIGHT, SPACESHIP_HEIGHT)
    yellow = pygame.Rect(55, 200, SPACESHIP_HEIGHT, SPACESHIP_HEIGHT)
